		...
		<div class="row justify-content-center">
			...
			<!--  form -->
				<form class="mb-5" action="addDealerLogic.jsp" method="post">
				  <div class="mb-3">
				    <label for="dealer_name" class="form-label"><i class="bi bi-person"></i> Dealer Shop Name</label>
				 ...
				 <div class="mb-3">
				    <label for="gst_number" class="form-label"><i class="bi bi-person"></i> GST Number</label>
				    <input type="text" class="form-control" id="gst_number" name="gstnumber" required placeholder="type gst number here...">
				    </div>
				    
				  <div class="row justify-content-center">
					  <div class="col col-4">
					  	<button type="submit" class="btn btn-success btn-sm"><i class="bi bi-person-plus"></i> Add Dealer</button>
					  </div>
				  </div>
			</form >
